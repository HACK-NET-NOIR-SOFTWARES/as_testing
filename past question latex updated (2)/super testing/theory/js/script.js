...
const imagePaths = ["image/s2.jpg", "image/s3.png", "image/s4.gif", "image/s5.gif", "image/s1.gif"]
...
function showTheoryImg(index) {
    ...
    if(activatedArray[index].image == undefined  || activatedArray[index].image == null) {
    ...
    const que_text = document.querySelector(".que_text");
     ...
     if(questions.length <= 0) {
        ...
        if(questions[index].maths == true) {
            ...
            let questionSet = questions[index].question
            let question_options = ""
            for (let i = 0; i < questionSet.length; i++) {
                question_options += '<div><span>' + questionSet[i] + '</span></div>';
            }
            que_tag = '<div class="image-container"></div>' + question_options;
            console.log(que_tag)

        } else if(questions[index].maths == 'false' || questions[index].maths == undefined || questions[index].maths == null) {
            ...
            let answerSet = questions[index].answerSet;
                ...
                if(questions[index].maths == true) { //i turned it to false
                    // Loop through the answer set, starting from index 1 to skip the first empty summary string
                    ...
                    optionTag =
                        '<div class="image-container"></div>' + options;
                    ...
                    optionTag =
                        '<div class="image-container"><span class="image-container">' + answerSet[0] + '</span></div>' + options;
                }
                    ...
                    if(questions[index].maths == false) {//i turned it to false
                        ...
                        if(questions[index].moreQuestion == 'false' || questions[index].moreQuestion == undefined || questions[index].moreQuestion == null) {
